...
void main() {
  ...
  group('GroupsCubit', () {
    ...
    blocTest<GroupsCubit, GroupsState>(
      ...
      expect: () => [
        GroupsState(groups: groups, currState: CubitState.loading),
        GroupsState(
            groups: groups,
            currState: CubitState.failure,
    ...
    blocTest<GroupsCubit, GroupsState>(
      ...
      build: () {
        when(mockNetworkManager.isConnected()).thenAnswer((_) async => true);
          when(mockGetGroupsUseCase.call())
            .thenAnswer((_) async => Right(groups2));
      ...
      expect: () => [
        ...
        groupsCubit.state.copyWith(
            groups: groups2, currState: CubitState.success, errorMessage: null),
      ],
    );
  });
}
